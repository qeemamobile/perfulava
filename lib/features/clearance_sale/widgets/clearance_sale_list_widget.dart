  ...
  Widget build(BuildContext context) {
    return Consumer<ProductController>(
      ...
      return productController.clearanceProductModel != null
          ? (productController.clearanceProductModel?.products != null &&
                  productController.clearanceProductModel!.products!.isNotEmpty)
              ? Column(
                  children: [
                    Padding(
                      ...
                      child: ClearanceTitleRowWidget(
                        title:
                            '${getTranslated('clearance_sale_banner', context)}',
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (_) =>
                                    const ClearanceSaleAllProductScreen())),
                      ),
                    ),
                    SizedBox(
                      ...
                      child: CarouselSlider.builder(
                          ...
                          itemCount: productController
                              .clearanceProductModel?.products?.length,
                          itemBuilder: (context, index, _) => ProductWidget(
                              productModel: productController
                                  .clearanceProductModel!.products![index],
                              productNameLine: 1)),
                    ),
                  ],
                )
