...
class WishListScreen extends StatefulWidget {
  ...
  const WishListScreen({super.key,this.isBacButtonExist=true});
  @override
...
class _WishListScreenState extends State<WishListScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(isBackButtonExist: widget.isBacButtonExist,title: getTranslated('wishList', context,)),
