...
import 'package:flutter_sixvalley_ecommerce/features/home/widgets/location_appbar_icon_widget.dart';
import 'package:flutter_sixvalley_ecommerce/features/home/widgets/notification_appbar_icon_widget.dart';
...
import 'package:flutter_sixvalley_ecommerce/features/product/widgets/product_gridview_widget.dart';
...
import '../../more/widgets/square_item_widget.dart';
import '../../more/widgets/title_button_widget.dart';
import '../../notification/screens/notification_screen.dart';
import '../widgets/cart_appbar_icon_widge.dart';
import '../widgets/image_profile_appbar_widget.dart';
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          FittedBox(
                            child: NotificationAppbarIconWidget(
                      ...
                      InkWell(
                        onTap: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                                builder: (_) =>
                                    const LocationAppbarIconWidget())),
                        child: Row(
                          children: [
                            Text(getTranslated('Delivery to : ', context) ?? '',
                      ...
                      const SizedBox(
                        height: 40,
                        child: FittedBox(child: ImageProfileAppbarWidget()),
                      ),
                    ],
                  )),

              ///TODO:⭐  discount for 50 % ⭐
              // SliverToBoxAdapter(
                                              ...
                                              return InkWell(
                                                  ...
                                                  child: Padding(
                                                      ...
                                                      child: Container(
                                                          ...
                                                          decoration: BoxDecoration(borderRadius: BorderRadius.circular(Dimensions.paddingSizeExtraSmall), color: Theme.of(context).cardColor, border: Border.all(width: 1, color: index == productController.selectedProductTypeIndex ? Theme.of(context).primaryColor.withValues(alpha: .5) : Theme.of(context).cardColor)),
