...
class LocationAppbarIconWidget extends StatefulWidget {
  final bool fromGuest;
  const LocationAppbarIconWidget({super.key,  this.fromGuest = false});

  @override
  State<LocationAppbarIconWidget> createState() => _LocationAppbarIconWidgetState();
}

class _LocationAppbarIconWidgetState extends State<LocationAppbarIconWidget> {
        ...
        builder: (context, locationProvider, child) {
          return Column(
            children: [
              ...
              locationProvider.addressList!.isNotEmpty ?  ListView.builder(
