      ...
      child: Container(padding:  const EdgeInsets.symmetric(
        ...
        child: Container(
          ...
          Dimensions.homePagePadding : Dimensions.paddingSizeExtraSmall,
            ...
            Dimensions.paddingSizeExtraSmall : Dimensions.homePagePadding),
          ...
          child: Row(
           ...
           children: [
            Container(width: 40,height: 40,
              ...
              Colors.white :  Theme.of(context).primaryColor, size: Dimensions.iconSizeSmall),
            ),
            ...
            Container(width: 60,height: 60,
              decoration:const BoxDecoration(
                borderRadius:  BorderRadius.all(Radius.circular(Dimensions.paddingSizeExtraSmall))),
              child: Icon(Icons.camera_alt, color: Provider.of<ThemeController>(context, listen: false).darkTheme?
              Colors.white :  Theme.of(context).primaryColor, size: Dimensions.iconSizeSmall
