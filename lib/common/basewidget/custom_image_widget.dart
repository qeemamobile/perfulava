...
import 'package:flutter_sixvalley_ecommerce/utill/cache_manager.dart';
...
class CustomImageWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CachedNetworkImage(
       memCacheHeight: 300, // Limit cached image height
  memCacheWidth: 300,  // Limit cached image width
